...
public class Suit {
    ...
    public Suit(ShiveluchService service, int id, String Name, String Description,int stamina,int suitImage, int basic_resist_fire, int basic_resist_grav, int basic_resist_poison, int basic_resist_psi, int basic_resist_rad, int basic_resist_electro){
