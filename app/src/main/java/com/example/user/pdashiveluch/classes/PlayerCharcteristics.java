...
//            return;
    ...
    public void GiveSuitKurt() { SetSuit(new Suit(service,1,"Кожаная куртка","Нет описания",1000,R.drawable.stalknew,5,5,10,0,5,10));    }
    public void GiveSuitZaria(){ suit=new Suit(service,2,"Заря","Нет описания",1000,R.drawable.stalknew,25,25,20,0,35,20);}
    public void GiveSuitSeva(){ suit=new Suit(service,3,"Сева","Нет описания",1000,R.drawable.stalknew,40,40,35,0,50,35);}
    public void GiveSuitExo(){ suit=new Suit(service,4,"Экзоскелет","Нет описания",1000,R.drawable.stalknew,60,60,55,5,60,55);}
    public void GiveSuitBand(){ suit=new Suit(service,5,"Бандитская куртка","Нет описания",1000,R.drawable.stalknew,10,10,10,0,0,10);}
    public void GiveSuitPlas(){ suit=new Suit(service,6,"Кожаный плащ","Нет описания",1000,R.drawable.stalknew,15,10,10,0,5,10);}
    public void GiveSuitBron(){ suit=new Suit(service,7,"Армейский бронежилет","Нет описания",1000,R.drawable.stalknew,15,15,15,0,15,15);}
    public void GiveSuitBulat(){ suit=new Suit(service,8,"Булат","Нет описания",1000,R.drawable.stalknew,35,20,25,0,20,25);}
    public void GiveSuitBerill(){ suit=new Suit(service,9,"Берилл","Нет описания",1000,R.drawable.stalknew,50,35,40,0,35,40);}
    public void GiveSuitDolgKombez(){ suit=new Suit(service,10,"Комбинезон Долга (ПС3-9д)","Нет описания",1000,R.drawable.stalknew,25,25,25,0,25,25);}
    public void GiveSuitDolgBron(){ suit=new Suit(service,11,"Броня Долга (ПС3-9Мд)","Нет описания",1000,R.drawable.stalknew,40,40,40,0,40,40);}
    public void GiveSuitDolgExa(){ suit=new Suit(service,12,"Экзоскелет Долга","Нет описания",1000,R.drawable.stalknew,60,60,55,10,55,60);}
    public void GiveSuitStrazh(){ suit=new Suit(service,13,"Страж Свободы","Нет описания",1000,R.drawable.stalknew,20,20,35,0,30,20);}
    public void GiveSuitVeter(){ suit=new Suit(service,14,"Ветер Свободы","Нет описания",1000,R.drawable.stalknew,35,35,50,0,45,35);}
    public void GiveSuitFreeExa(){ suit=new Suit(service,15,"Экзоскелет Свободы","Нет описания",1000,R.drawable.stalknew,55,50,65,10,65,55);}
    public void GiveSuitMonKombez(){ suit=new Suit(service,16,"Комбинезон Монолита","Нет описания",1000,R.drawable.stalknew,30,30,30,100,30,30);}
    public void GiveSuitMonBron(){ suit=new Suit(service,17,"Броня Монолита","Нет описания",1000,R.drawable.stalknew,45,45,45,100,45,45);}
    public void GiveSuitMonExa(){ suit=new Suit(service,18,"Экзоскелет Монолита","Нет описания",1000,R.drawable.stalknew,60,60,60,100,60,60);}
    public void GiveSuitNaemKombez(){ suit=new Suit(service,19,"Комбинезон Наёмников","Нет описания",1000,R.drawable.stalknew,25,35,20,0,20,25);}
    public void GiveSuitNaemBron(){ suit=new Suit(service,20,"Броня Наёмников","Нет описания",1000,R.drawable.stalknew,40,50,35,0,35,40);}
    public void GiveSuitCS1(){ suit=new Suit(service,21,"Комбинезон ЧН-1","Нет описания",1000,R.drawable.stalknew,15,20,25,0,25,15);}
    public void GiveSuitCS2(){ suit=new Suit(service,22,"Броня ЧН-2","Нет описания",1000,R.drawable.stalknew,28,33,38,0,38,28);}
    public void GiveSuitCS3(){ suit=new Suit(service,23,"Бронекостюм ЧН-3а","Нет описания",1000,R.drawable.stalknew,45,50,55,5,60,45);}
    public void GiveSuitHalat(){ suit=new Suit(service,24,"Халат Ученых","Нет описания",1000,R.drawable.stalknew,5,5,5,0,5,5);}
    public void GiveSuitEcolog(){ suit=new Suit(service,25,"Эколог (ССП-99)","Нет описания",1000,R.drawable.stalknew,28,28,38,5,38,28);}
    public void GiveSuitEcolog2(){ suit=new Suit(service,26,"ССП-99М","Нет описания",1000,R.drawable.stalknew,45,45,55,5,55,45);}
    public void GiveSuitMonster(){ suit=new Suit(service,27,"Костюм «Монстр»","Нет описания",1000,R.drawable.stalknew,90,90,90,90,90,90);}
    public void GiveSuitIgrotex(){ suit=new Suit(service,28,"Костюм «Игротех»","Нет описания",1000,R.drawable.stalknew,100,100,100,100,100,100);}
    public void GiveSuitBolot(){ suit=new Suit(service,29,"Костюм «Болотный Доктор»","Нет описания",1000,R.drawable.stalknew,75,75,75,75,75,75);}



    /*public void GiveSuitKurtka() {
        SetSuit(new Suit(service,1,"СТАЛКЕРСКАЯ КУРТКА","Не обеспечивает даже самой минимальной защиты. Дешевая и распространенная",1000,R.drawable.stalknew,
                5,0,0,0,0));
    }
