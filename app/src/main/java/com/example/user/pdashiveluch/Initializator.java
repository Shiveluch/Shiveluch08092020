...
public class Initializator {
    ...
    public static HashMap<Number,Group> Groups(){
        ...
        groups.put(1,new Group(1,"Вольные сталкеры", new Places[]{Places.Bar,Places.Village}));
        groups.put(2,new Group(2,"ДОЛГ",new Places[]{Places.Dolg}));
        groups.put(3,new Group(3,"Бандиты",new Places[]{Places.Bandos}));
        groups.put(4,new Group(4,"Свобода",new Places[]{Places.Freedom}));
        groups.put(5,new Group(5,"Учёные",new Places[]{Places.Sci}));
        groups.put(6,new Group(6,"Монолит",new Places[]{Places.Monolit}));
        groups.put(7,new Group(7,"Военные",new Places[]{Places.Military}));
        groups.put(8,new Group(8,"Наёмники",new Places[]{Places.Mercs}));
        groups.put(9,new Group(9,"Чистое небо",new Places[]{Places.ClearSky}));
        groups.put(10,new Group(10,"Военный сталкер",new Places[]{Places.Sci}));
        groups.put(11,new Group(11,"Ренегаты",new Places[]{Places.Renegades}));
        groups.put(12,new Group(12,"Монстры",new Places[]{Places.Monolit}));
