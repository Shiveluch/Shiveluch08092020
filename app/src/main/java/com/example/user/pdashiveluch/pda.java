...
public class pda extends AppCompatActivity {
    ...
    TextView tvProgressHorizontal, tv_rad, callsign,
            team_name, anomaly, inv_t, s_info, tv_suit, uron, eventtext, rank, callsign_2, faction, ranknew,
    ...
    ImageView art_but, rules_but, master_but, OK_but, artslot1,log_menu,  effectlogo,
...
//        });
        ...
        mil_med.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                SendActionBroadcast("UseMilMedkit");
            }
        });
        ...
        repairs_image.setOnClickListener(new OnClickListener() {
                                             @Override
                                             public void onClick(View v) {
                                                 SendActionBroadcast("UseRepairs");
                                             }
                                         });
                ...
                sci_med.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SendActionBroadcast("UseSciMedkit");
                    }
                });
...
//ОБРАБОТЧИК НАЖАТИЯ НА АНТИРАД
        antirad_new.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                SendActionBroadcast("UseAntirad");
            }
        });
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.menu3:
                                ...
                                return true;
                            case R.id.menu4:
                                SendActionBroadcast("setAtmoSound");
                                return true;
