...
public class ShiveluchService extends Service {
            ...
            switch(action){
                ...
                case "ShiveluchActivity.Action":
                    ...
                    switch(ExtraAction) {
                        ...
                        case "setAtmoSound":
                            AtmoSoundStatus=!AtmoSoundStatus;
                            if (AtmoSoundStatus)
                            {
                                NotifyToast("Звуки включены");
                            }
                            else
                            {
                                NotifyToast("Звуки отключены");
                            }
                            break;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(!reset){
            ...
            InitPlayerCharacteristic(intent.getStringExtra("Name"), intent.getIntExtra("GroupID", 1), 2, 0,0,2, false, false, false, false, false, false, false,false, false, false, false, false, false);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action){
                case BluetoothDevice.ACTION_FOUND:
                    ...
                    Debug.Log("Мощность "+rssi+" Из датапака "+playerCharcteristics.getDistance() );
                    ...
                    case Mine:
                        ...
                        if ( resist== 0) {
                            ...
                            if (resist<100) {
                                ...
                                if (rstype < 80) {
                                    playerCharcteristics.DamageSuit(50);
                                    playerCharcteristics.Damage(5000);
                    ...
                    case Psi:
                        ...
                        if(playerCharcteristics.getGroup().isBasePlace(Places.Monolit)) {
                            ...
                            if(!playerCharcteristics.isPsi_helm()) {
                                ...
                                if (poweran>=9 && !playerCharcteristics.getGroup().isBasePlace(Places.Monolit))
                                {playerCharcteristics.Damage(playerCharcteristics.getHeal_big());
...
//                                    }
                    ...
                    case MonolitPiece:
                        loctime=timer;
                        if(!playerCharcteristics.isPsi_helm() || !playerCharcteristics.getGroup().isBasePlace(Places.Monolit)) {
                            if(!playerCharcteristics.isMonvoice()) {
                                myAudioManager.PlaySound(PDA_AudioManager.AppSounds.MONOLIT);
...
//                                    }
    ...
    private void LoadState(){
        ...
        if(!ResetPlayer){
            ...
            playerCharcteristics.setMedikits(servicePreferences.getInt("Medkits",1));
            ...
            playerCharcteristics.setAntirads(servicePreferences.getInt("Antirads",1));
